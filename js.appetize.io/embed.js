var he = (w, y, v) => {
  if (!y.has(w)) throw TypeError("Cannot " + v);
};
var C = (w, y, v) => (
    he(w, y, "read from private field"), v ? v.call(w) : y.get(w)
  ),
  q = (w, y, v) => {
    if (y.has(w))
      throw TypeError("Cannot add the same private member more than once");
    y instanceof WeakSet ? y.add(w) : y.set(w, v);
  },
  V = (w, y, v, E) => (
    he(w, y, "write to private field"), E ? E.call(w, v) : y.set(w, v), v
  );
var appetize = (function (w) {
  var L, P;
  ("use strict");
  class y {
    constructor() {
    ...
    createLogFn(e) {
      ...
      return (
        (s.once = (r) => {
          if (!t.has(r)) return t.add(r), s.call(console, r);
        }),
        s
      );
    }
  ...
  (d.prototype.getMaxListeners = function () {
    ...
    (d.prototype.emit = function (e) {
      ...
      if (typeof c == "function") H(c, this, t);
      else
        for (var h = c.length, u = Z(c, h), i = 0; i < h; ++i) H(u[i], this, t);
      return !0;
    });
  function X(n, e, t, i) {
    var s, r, o;
    if (
      ...
      (r = n._events),
      r === void 0
        ? ((r = n._events = Object.create(null)), (n._eventsCount = 0))
  ...
  function Y(n, e, t) {
    var i = { fired: !1, wrapFn: void 0, target: n, type: e, listener: t },
      s = le.bind(i);
  ...
  (d.prototype.once = function (e, t) {
    ...
    (d.prototype.removeListener = function (e, t) {
      var i, s, r, o, a;
      if ((D(t), (s = this._events), s === void 0)) return this;
  ...
  function fe(n, e) {
    return new Promise(function (t, i) {
      function s(o) {
        n.removeListener(e, r), i(o);
      }
      function r() {
        typeof n.removeListener == "function" && n.removeListener("error", s),
          t([].slice.call(arguments));
      }
      ee(n, e, r, { once: !0 }), e !== "error" && me(n, s, { once: !0 });
    });
  }
  function me(n, e, t) {
  ...
  function ee(n, e, t, i) {
    if (typeof n.on == "function") i.once ? n.once(e, t) : n.on(e, t);
    else if (typeof n.addEventListener == "function")
      n.addEventListener(e, function s(r) {
        i.once && n.removeEventListener(e, s), t(r);
      });
    else
      throw new TypeError(
    ...
    constructor({ socket: e, logger: t = new y() }) {
      super(),
        ...
        this.socket.on("*", ({ type: i, value: s }) => {
          ...
          r !== null &&
            (r
              ? (this.emit(r.type, r.value), this.emit("*", r))
              : (this.emit(i, s), this.emit("*", { type: i, value: s })));
        }),
        this.socket.on("newSession", () => {
          this.queue && (this.emit("queueEnd"), (this.queue = void 0));
        }),
        this.on("queue", (i) => {
          this.queue = i;
        });
    ...
    async waitForSessionStart(e) {
      return new Promise(async (t, i) => {
        const s = () => {
          ...
          o = (a) => {
            a.message.match(/Too many requests/) &&
              i(new Error("Session failed to start due to too many requests"));
          };
        try {
          this.on("error", o),
            e.on("disconnect", s),
          ...
          this.off("error", o), e.off("disconnect", s), e.off("error", r);
        }
        t(e);
      });
    }
  ...
  function ye(n, e) {
    switch (n) {
      case "concurrentQueue":
        return {
          type: "queue",
          value: { type: "concurrent", name: e.name, position: e.position },
        };
      case "queue":
        return {
          type: "queue",
          value: { type: "session", position: e.position },
        };
      case "userError":
  ...
  function A(n) {
    return Array.isArray(n)
      ? n.map(A).filter((e) => e != null)
      : typeof n == "object" && n !== null
      ? Object.entries(n).reduce((e, [t, i]) => {
          const s = A(i);
          return s != null && (e[t] = s), e;
        }, {})
      : n;
  }
  function te(n, e) {
    if ("captureStackTrace" in Error) Error.captureStackTrace(n, e);
    else {
      const t = new Error();
      Object.defineProperty(n, "stack", {
        ...
        get() {
          const { stack: i } = t;
          return Object.defineProperty(this, "stack", { value: i }), i;
        },
      });
    }
  }
  ...
  class ke extends I {
    constructor(e) {
      ...
      if (e.message.match("outside the screen bounds")) {
        ...
        "localPosition" in i && i.localPosition
          ? (t = `localPosition (${i.localPosition.x}, ${i.localPosition.y}) for the element evaluates to a coordinate outside of screen bounds.`)
          : (t = "Element is outside of screen bounds.");
      }
      super(e, t);
    }
  }
...
${JSON.stringify(e.playback.action, null, 2)}`
  ...
  class se extends g {
    constructor(e, t) {
      super(t), (this.playback = e);
    }
  }
  class $ extends g {
    constructor(e) {
      super(
        `App Recorder must be enabled to use ${e}. Please set "record" to true in the config.`
      );
    }
  }
  function Ae(n) {
...
...and ${n.length - 5} more`
  ...
  async function W(n, e, t) {
    const i = typeof t == "function" ? {} : t,
      ...
      r =
        typeof (i == null ? void 0 : i.timeout) != "undefined"
          ? i.timeout
          : 1e4;
      ...
      n.on(e, c),
        r !== null &&
          setTimeout(() => {
            n.off(e, c),
              a(
                new R(`Timeout ${r}ms exceeded while waiting for event "${e}"`)
              );
          }, r);
    });
  }
  class Te extends we {
      ...
      super({ socket: e, logger: i }),
        ...
        this.window.on("*", async ({ type: r, value: o }) => {
          if (this.ready)
            switch (r) {
              case "app":
                (this.app = o), this.emit(r, o);
                break;
              case "deviceInfo":
                (this.device = o), this.emit(r, o);
                break;
              case "config":
            ...
            switch (r) {
              case "newSession":
                try {
                  ...
                  (this.session = void 0), this.emit("sessionError", a);
                }
            }
        }),
        this.init();
    }
    async init(e = { isReinit: !1 }) {
      await this.window.waitUntilReady();
      const t = async () => {
          if (e.isReinit) {
            const r = this._config,
              o = await this.setConfig({});
            return this.setConfig({ record: !0, ...r, ...o });
          } else return this.setConfig({ record: !0, ...this._config });
        },
        [i, s] = await Promise.all([
          this.window.postMessage({ type: "getApp" }, !0),
          this.window.postMessage({ type: "getDeviceInfo" }, !0),
          t(),
        ]);
      (this.app = i), (this.device = s), (this.ready = !0);
    }
    ...
    async startSession(e) {
      ...
      const [t] = await Promise.all([
        new Promise((i, s) => {
          const r = (a) => {
              this.off("session", r), this.off("sessionError", o), i(a);
            },
            o = (a) => {
              this.off("session", r), this.off("sessionError", o), s(a);
            };
          this.on("session", r), this.on("sessionError", o);
        }),
        this.window.postMessage({ type: "requestSession" }, !0),
      ]);
      return t;
    }
    async config(e) {
    ...
    async setConfig({ publicKey: e, ...t }) {
      if (e) {
        const s = await this.window.postMessage(
          { type: "loadApp", value: e },
          !0
        );
        if (s && "error" in s) throw new Error(s.error);
      }
      const i = await this.window
        .postMessage(
          { type: "setConfig", value: this.validateConfig(t != null ? t : {}) },
          !0
        )
        .then(this.mapConfig.bind(this));
      return (this._config = i), i;
    }
    mapConfig(e) {
      return (
        e.autoplay === !0 &&
        ...
        { ...A(e), device: e.deviceType || e.device }
      );
    }
    validateConfig(e) {
      return e;
  ...
  function T(n) {
    if (typeof n == "string") {
      if (n.endsWith("%")) return parseInt(n, 10) / 100;
      throw new Error(
        `Invalid position value: ${n}. Must be a number between 0 and 1, or a string ending with %`
      );
    }
    return n;
  }
  class Le {
    constructor({ platform: e, screen: t, app: i }) {
      (this.platform = e), (this.screen = t), (this.app = i);
    }
    pixelToDip(e) {
    ...
    getCoordinates(e, t) {
      const i = T(e.x),
        s = T(e.y);
      return { x: i * t.width, y: s * t.height };
    }
    mapHardwareKey(e) {
      switch (e) {
        case "HOME":
        ...
        (() => {
          ...
          if (
            ...
            if (!x.isValidNumber(o) || !x.isValidNumber(a))
              throw new g(
                `Invalid position: (${e.position.x}, ${e.position.y}). Values must be a number or a percentage`
              );
            if (!x.isPositionWithinBounds(e.position))
              throw typeof e.position.x == "string"
                ? new Error(
                    `Invalid position: (${e.position.x}, ${e.position.y}) must be within (0%, 0%) and (100%, 100%)`
                  )
                : new Error(
                    `Invalid position: (${e.position.x}, ${e.position.y}) must be within (0, 0) and (1, 1)`
                  );
            ...
            if (
              !x.isValidNumber(e.coordinates.x) ||
              !x.isValidNumber(e.coordinates.y)
            )
              throw new g(
                `Invalid coordinates: (${e.coordinates.x}, ${e.coordinates.y}). Values must be a number`
              );
            if (
              !x.isCoordinatesWithinBounds(e.coordinates, {
                width: this.screen.width - 1,
                height: this.screen.height - 1,
              })
            )
              throw new g(
                `Invalid coordinates: (${e.coordinates.x}, ${
                  e.coordinates.y
          ...
          if ("localPosition" in e && e.localPosition) {
            ...
            if (!x.isValidNumber(o) || !x.isValidNumber(a))
              throw new g(
                `Invalid localPosition: (${e.localPosition.x}, ${e.localPosition.y}). Values must be a number or a percentage`
              );
            r = { x: o, y: a };
          } else i && (r = { x: 0.5, y: 0.5 });
          if ("duration" in e && e.duration && !x.isValidNumber(e.duration))
            throw new g(
              `Invalid duration: ${e.duration}. Value must be a number`
            );
          switch (e.type) {
            case "tap": {
              const { position: o, ...a } = e;
              return { ...a, element: i, localPosition: r, coordinates: s };
            }
            case "swipe": {
              const { position: o, ...a } = e;
              return {
            ...
            case "keypress": {
              ...
              return {
                ...
                key: o,
                character: a,
                shiftKey: this.platform === "ios" ? Pe(e.shiftKey) : e.shiftKey,
              };
            }
            case "findElements":
              return { ...e, element: i };
        ...
        r = () => {
          if (i) {
            ...
            return this.platform === "android"
              ...
              : { x: j(a), y: j(c), width: j(h), height: j(u) };
          }
        },
        o = () => {
          if (t)
  ...
  class Ce {
      ...
      return A(
        (() => {
          let i,
            s,
            r,
            o = "localPosition" in e ? e.localPosition : void 0;
          switch (
            ("coordinates" in e &&
              e.coordinates &&
              ((s = {
            ...
            "element" in e &&
              e.element &&
              ((i = this.mapElement(e.element)),
              s &&
                i.bounds &&
                (o = this.getPosition(
                  { x: s.x - i.bounds.x, y: s.y - i.bounds.y },
                  { width: i.bounds.width, height: i.bounds.height }
                ))),
            e.type)
          ) {
            case "tap":
              return { ...e, element: i, position: r, localPosition: o };
            case "swipe":
              return {
                ...e,
                element: i,
                ...
                moves: e.moves.map((a) => {
                  const { x: c, y: h } = this.getPosition(
                    { x: this.pixelToDip(a.x), y: this.pixelToDip(a.y) },
                    {
                      width: this.screen.width - 1,
                      height: this.screen.height - 1,
                    }
                  );
                  return { x: c, y: h, t: a.t };
                }),
              };
            case "keypress": {
      ...
      return (
        t &&
          (this.platform === "ios"
            ...
            : r.push({ type: "app", children: t.map(s) })),
        i &&
          r.push({
            type: "app",
      ...
      const { attributes: t, bounds: i, accessibilityElements: s, ...r } = e,
        o = (h) =>
          this.platform === "android"
            ...
            : { x: K(h.x), y: K(h.y), width: K(h.width), height: K(h.height) },
        a = (h) =>
          Object.keys(h).reduce((u, l) => {
            switch (l) {
              case "userInteractionEnabled":
              case "isHidden":
                return { ...u, [l]: h[l] === "1" };
        ...
        c = (h) =>
          h.map((u) => {
            ...
            return { ...a(u), accessibilityFrame: l ? o(l) : void 0 };
          });
      return A({
        ...r,
        bounds: i ? o(i) : void 0,
    ...
    mapAppetizerEvent(e, t) {
      ...
      switch (e) {
        case "debug":
          return { type: "log", value: t };
        case "interceptResponse":
          return { type: "network", value: { type: "response", ...t } };
        case "interceptRequest":
          return { type: "network", value: { type: "request", ...t } };
        case "interceptError":
          return { type: "network", value: { type: "error", ...t } };
        case "userError":
          return { type: "error", value: t };
        case "recordedAction":
          return { type: "action", value: this.mapAction(t) };
        case "playbackFoundAndSent": {
          ...
          return {
            ...
            value: {
              ...
              playback: {
                ...r.playback,
                action: r.playback.action
                  ? this.mapAction(r.playback.action)
                  : void 0,
              },
              matchedElements:
                (i = r.matchedElements) == null
                  ? void 0
                  : i.map((o) => {
                      if (o) return this.mapElement(o);
                    }),
            },
          };
        }
        ...
        case "uiDump":
          return { type: "uiDump", value: this.mapUI(t) };
        case "userInteractionReceived":
          return { type: "interaction", value: t };
        case "countdownWarning":
          return { type: "inactivityWarning", value: t };
        case "h264Data":
          return { type: "video", value: { ...t, codec: "h264" } };
        case "frameData":
          return { type: "video", value: { ...t, codec: "jpeg" } };
        case "audioData":
          return { type: "audio", value: { ...t, codec: "aac" } };
        case "deleteEvent":
          return null;
      }
    }
  ...
  function Ie(n) {
    ...
    if (i.length > 0) {
      ...
      throw new Error(
        `Element has invalid properties: ${s}. Did you mean to put these under 'attributes'?`
      );
    }
    return n;
  }
  ...
  class _e {
    ...
    to(e, t) {
      ...
      return (
        this.moves.push({ x: parseFloat(e) / 100, y: parseFloat(t) / 100 }),
        this
      );
    }
    wait(e) {
      ...
      return t && (t.wait = e + ((i = t.wait) != null ? i : 0)), this;
    }
    build() {
      var a;
      const e = this.stepDuration,
        t =
          (a = this.duration) != null
            ? a
            : Math.max(500, e * (this.moves.length - 1)),
        i = Math.floor(t / e),
      ...
      if (s === 0) {
        ...
        throw new Error(
          `Duration is too short for ${
            this.moves.length - 1
          } moves, please set duration to at least ${c}ms`
        );
      }
      for (let c = 0; c < this.moves.length - 1; c++) {
        ...
        for (let f = 0; f <= s; f++) {
          ...
          r.push({ x: k, y: S, t: M }),
            f === 0 &&
              h.wait &&
              (r.push({ x: k, y: S, t: M + h.wait / 1e3 }), (o += h.wait));
        }
        if (c === this.moves.length - 2 && u.wait) {
          const f = r[r.length - 1];
          r.push({ x: f.x, y: f.y, t: f.t + u.wait / 1e3 });
        }
      }
      return r;
    }
  ...
  class Oe extends N {
    constructor({
      ...
      const h = ({ type: u, value: l }) => {
        ...
        m
          ? (this.emit(m.type, m.value), this.emit("*", m))
          : m !== null &&
            (this.emit(u, l), this.emit("*", { type: u, value: l }));
      };
      this.socket.on("*", h),
        this.on("disconnect", () => {
          this.socket.off("*", h),
            this.isEndingManually ||
              (this.countdownWarning
                ? this.logger.warn(
    ...
    async waitForEvent(t, i) {
      try {
        ...
        throw (p(s, this.waitForEvent), s);
      }
    }
    async end() {
      (this.isEndingManually = !0), await this.socket.disconnect();
    }
    ...
    async screenshot(t = "buffer") {
      ...
      try {
        ...
        const s = await W(this.socket, "screenshot", { timeout: 6e4 });
        if (!s.success)
          throw new g((i = s.error) != null ? i : "Screenshot failed");
        return {
          data:
            t === "buffer"
              ? ((a) => (typeof window == "undefined" ? Buffer.from(a) : a))(
                  s.data
                )
              : Me(new Uint8Array(s.data), s.mimeType),
          mimeType: s.mimeType,
        };
      } catch (s) {
        throw (p(s, this.screenshot), s);
      }
    }
    async heartbeat() {
      try {
        ...
        throw (p(t, this.heartbeat), t);
      }
    }
    async type(t) {
      try {
        await U(1e3);
        const i = await this.playAction({ type: "typeText", text: t });
        return await U(500), i;
      } catch (i) {
        throw (p(i, this.type), i);
      }
    }
    async keypress(t, i) {
      try {
        ...
        } else return this.playAction({ type: "keypress", character: t });
      } catch (s) {
        throw (p(s, this.keypress), s);
      }
    }
    async setLanguage(t) {
      try {
    ...
    async toggleSoftKeyboard() {
      try {
        ...
        throw (p(t, this.toggleSoftKeyboard), t);
      }
    }
    async biometry({ match: t }) {
      try {
        ...
        throw (p(i, this.biometry), i);
      }
    }
    async allowInteractions(t) {
      try {
        return await this.socket.send(
          t ? "enableInteractions" : "disableInteractions"
        );
      } catch (i) {
        throw (p(i, this.allowInteractions), i);
      }
    }
    async restartApp() {
      try {
    ...
    async adbShellCommand(t) {
      ...
      try {
        ...
        throw (p(i, this.adbShellCommand), i);
      }
    }
    async playAction(t, i = {}) {
      const { timeout: s = 1e4 } = i,
        ...
        o = s + 1e4;
      try {
        if (!this.config.record) throw new $("playAction()");
        if (isNaN(s)) throw new g(`Invalid timeout value: ${i.timeout}`);
        if (s < 0)
        ...
        const a = new Le({
          ...
          u = {
            id: ge(),
            action: h,
            options: { ...i, timeout: Math.round(Math.min(s, r) / 1e3) },
          };
        try {
          return await new Promise((f, m) => {
            const k = setTimeout(() => {
                S(),
                  m(
                    new se(
                      { id: u.id, action: t, timeout: u.options.timeout },
              ...
              M = async (b) => {
                var _;
                ((_ = b.playback) == null ? void 0 : _.id) === u.id &&
                  (S(), f(b));
              },
              ce = async (b) => {
                var _;
          ...
          const f = Math.max(0, s - r);
          if (f > 0 && !(l instanceof se) && !(l instanceof ie))
            return await this.playAction(t, { ...i, timeout: f });
          throw l;
        }
      } catch (a) {
        throw (p(a, this.playAction), a);
      }
    }
    async playActions(t, i = {}) {
      try {
        if (!this.config.record) throw new $("playActions()");
        const s = [];
        for (const r of t) {
          const o = await this.playAction(r, i);
          s.push(o);
          const a = t[t.indexOf(r) + 1];
          (a && a.type === "keypress" && r.type === "keypress") ||
            (await this.waitForAnimations({ timeout: 2e3 }).catch(() => {}));
        }
        return s;
      } catch (s) {
        throw (p(s, this.playActions), s);
      }
    }
    async getUI({ timeout: t = 3e4 } = {}) {
      try {
        return (
          this.socket.send("dumpUi"), await W(this, "uiDump", { timeout: t })
        );
      } catch (i) {
        throw (p(i, this.getUI), i);
      }
    }
    ...
    async findElements(t, i) {
      try {
        ...
        throw (p(s, this.findElements), s);
      }
    }
    async tap(t, i) {
      var s;
      try {
        if (!this.config.record) throw new $("tap()");
        ...
        throw (p(r, this.tap), r);
      }
    }
    async swipe({ duration: t, gesture: i, ...s }, r) {
      try {
        if (!this.config.record) throw new $("swipe()");
        let o;
        const a = new _e({ duration: t, stepDuration: s.stepDuration });
        ...
        if ("element" in s)
          ...
          o = { type: "swipe", position: s.position, moves: a.build() };
        else throw new Error("Either element or position must be specified");
        return this.playAction(o, r);
      } catch (o) {
        throw (p(o, this.swipe), o);
      }
    }
    async waitForAnimations(t = {}) {
      try {
        const { imageThreshold: i = 0.001, timeout: s = 1e4 } = t;
        let r = 1e3,
          o = 1;
        t.imageThresholdDuration && (r = t.imageThresholdDuration);
        const [a, c, h] = be(),
          u = setTimeout(() => {
            let m = `Timed out after ${s}ms waiting for animation to end.`;
            i < o &&
              (m += ` Waited for imageThreshold of ${i} but lowest was ${
                Math.round(o * 1e4) / 1e4
              }`),
              h(new R(m));
          }, s);
        let l;
        const f = ({ percentage: m, timestamp: k }) => {
          m < o && (o = m),
            m <= i ? (l || (l = k), l && k - l >= r && c()) : (l = void 0);
        };
        return (
          this.socket.send("enablePixelChangeDetection"),
          this.socket.on("pixelsChanged", f),
          this._waitForAnimationsPromises.add(a),
          await a.finally(() => {
            clearTimeout(u),
              this.socket.off("pixelsChanged", f),
              this._waitForAnimationsPromises.delete(a),
              this._waitForAnimationsPromises.size === 0 &&
                this.socket.send("disablePixelChangeDetection");
          })
        );
      } catch (i) {
        throw (p(i, this.waitForAnimations), i);
      }
    }
    async getAdbInfo() {
      return (
  ...
  function De(n) {
    ...
    if (!n || !n.forwards[0]) return;
    let t = e;
    return (
      (t = t.replace(/SERVER_PORT/, n.port.toString())),
  ...
  function ne({ type: n, value: e }) {
    switch (n) {
      case "deviceInfo":
        return { type: "deviceInfo", value: e };
      case "sessionRequested":
        return { type: "sessionRequested" };
      case "chromeDevToolsUrl":
        return { type: "networkInspectorUrl", value: e };
      case "orientationChanged":
        return { type: "orientationChanged", value: e };
    }
  }
  class re extends N {
      ...
      super(),
        ...
        this.window.on("*", ({ type: i, value: s }) => {
          switch (i) {
            case "socketEvent":
              s.socket === this.type &&
                (this.emit(s.type, s.value),
                this.emit("*", { type: s.type, value: s.value }));
              break;
            case "disconnect":
              this.emit("disconnect"), this.emit("*", { type: "disconnect" });
              break;
            case "sessionInfo":
            case "chromeDevToolsUrl":
            case "orientationChanged":
            case "deviceInfo":
              if (this.type === "appetizer") {
                const r = ne({ type: i, value: s });
                r && (this.emit(r.type, r.value), this.emit("*", r));
              }
              break;
            case "sessionRequested":
    ...
    async send(e, t) {
      var i;
      await this.window.waitUntilReady(),
        await ((i = this.window) == null
          ? void 0
          : i.postMessage({
              type: "emitSocketEvent",
              value: { type: e, value: t, socket: this.type },
            }));
    }
    async disconnect() {
  ...
  class Ne extends Oe {
    constructor({ window: e, config: t, ...i }) {
      const s = new re({ window: e, type: "appetizer" });
      super({ ...i, config: t, socket: s, logger: new y() }), (this.window = e);
    }
    async rotate(e) {
      try {
        const [t] = await Promise.all([
          this.waitForEvent("orientationChanged"),
          this.window.postMessage(e === "left" ? "rotateLeft" : "rotateRight"),
        ]);
        return await U(1e3), t;
      } catch (t) {
        throw (p(t, this.rotate), t);
      }
    }
    async end() {
      (this.isEndingManually = !0), await this.window.postMessage("endSession");
    }
  }
  const oe = "1.2.0";
  class $e extends N {
    ...
    async init() {
      await new Promise((e, t) => {
        let i;
        const s = () => {
            i == null || i.disconnect(), clearTimeout(r), clearInterval(o);
          },
          r = setTimeout(() => {
            this.selector &&
              (s(),
          ...
          o = setInterval(() => {
            ...
            if (this.contentWindow)
              (a.port1.onmessage = () => {
                if (((this.ready = !0), s(), c)) {
                  const f = () => {
                    s(), this.emit("reinit"), (this.ready = !1), this.init();
                  };
                  i = Fe(c, {
                    onSrcChange: () => {
                      this.ready = !1;
                ...
                (h = this.contentWindow) == null ||
                  h.postMessage(
                    { type: "init", appetizeClient: !0, version: oe },
                    "*",
                    [a.port2]
                  );
            else if (c && !c.src) {
              const f =
                (u = c.getAttribute("data-appetize-url")) != null
                  ? u
                  : "https://appetize.io";
              if ((l = this.initialConfig) != null && l.publicKey) {
                const { publicKey: m, ...k } = this.initialConfig;
                c.src = `${f}/embed/${this.initialConfig.publicKey}?${ve(k)}`;
              } else
                throw (
                  (s(), new Error("Missing publicKey in config in getClient()"))
                );
            }
          }, 100);
      });
    ...
    async postMessage(e, t = !1) {
      ...
      if (
        ((s = this.contentWindow) == null || s.postMessage(e, "*", [i.port2]),
        t)
      )
        return new Promise((r, o) => {
          ...
          i.port1.onmessage = (c) => {
            clearTimeout(a), i.port1.close(), i.port2.close(), r(c.data);
          };
        });
      i.port1.close(), i.port2.close();
    }
    getContentWindow() {
      var e;
      if (this.selector) {
    ...
    getIframe() {
      if (this.selector) return document.querySelector(this.selector);
    }
    handleWindowMessage(e) {
      ...
      const t =
        typeof e.data == "string"
          ...
          : i.type;
      this.contentWindow &&
        e.source === this.contentWindow &&
        (this.emit(t, (s = e.data) == null ? void 0 : s.value),
        this.emit("*", {
          type: t,
  ...
  function Fe(n, e) {
    const t = n.src,
      ...
      s = () => {
        n.removeEventListener("load", i), r.disconnect();
      };
    n.addEventListener("load", i);
    const r = new MutationObserver((o) => {
      o.forEach((a) => {
        a.type === "attributes"
          ? a.target === n && a.attributeName === "src" && e.onSrcChange()
          : a.type === "childList" &&
            a.removedNodes.forEach((c) => {
              c === n && e.onRemoved();
            });
      });
    });
  ...
  class ae extends Te {
    constructor({ selector: e, config: t } = {}) {
      const i = new $e({ selector: e, config: t });
      super({
        socket: new re({ window: i, type: "webserver" }),
        config: t,
        window: i,
      }),
        (this.ready = !1);
  ...
  async function Ue(n, e) {
    if (!n) throw new Error("selector is required");
    const t = new ae({ selector: n, config: e });
    return await t.waitUntilReady(), t;
  }
  function We(n) {
    return new ae({ config: n });
  }
  const Ke = oe;
  return (
    (w.getClient = Ue),
    (w.getWindowClient = We),
    (w.version = Ke),
